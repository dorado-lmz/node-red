(function (t) {
  ...
  var n = t.Backbone;var s = Array.prototype.slice;e.VERSION = "1.2.3";e.$ = r;e.noConflict = function () {
  ...
  };var l = e.Events = {};var c = /\s+/;var f = function (t, e, r, n, s) {
    var a = 0,
  ...
  };i.extend(y.prototype, l, { changed: null, validationError: null, idAttribute: "id", cidPrefix: "c", initialize: function () {}, toJSON: function (t) {
  ...
  };var w = { add: true, remove: true, merge: true };var E = { add: true, remove: false };var k = function (t, e, i) {
  ...
  };i.extend(x.prototype, l, { model: y, initialize: function () {}, toJSON: function (t) {
  ...
  };var A = /\((.*?)\)/g;var C = /(\(\?)?:\w+/g;var R = /\*\w+/g;var j = /[\-{}\[\]+?.,\\\^$|#\s]/g;i.extend($.prototype, l, { initialize: function () {}, route: function (t, r, n) {
  ...
  };var N = /^[#\/]|\s+$/g;var O = /^\/+|\/+$/g;var U = /#.*$/;M.started = false;i.extend(M.prototype, l, { interval: 50, atRoot: function () {
    ...
    } });e.history = new M();var q = function (t, e) {
...
//# sourceMappingURL=backbone-min-compiled.js.map